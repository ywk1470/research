  ...
  <el-container>
    ...
    <el-main>
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="主要内容" name="tab3" :disabled="showTab<3">
          主要内容
        </el-tab-pane>
        <el-tab-pane label="计划进度" name="tab4" :disabled="showTab<4">
          计划进度
        </el-tab-pane>
        <el-tab-pane label="经费预算" name="tab5" :disabled="showTab<5">
          经费预算
        </el-tab-pane>
        <el-tab-pane label="参与单位" name="tab6" :disabled="showTab<6">
          参与单位
        </el-tab-pane>
        <el-tab-pane label="附件上传" name="tab7" :disabled="showTab<7">
          附件上传
        </el-tab-pane>
      </el-tabs>
      <el-row>
  ...
  methods: {
    getAction() {
      if (this.$route.query.action) {
        ...
        this.action === 'new' ? this.showTab = 1 : this.showTab = 7
      }
    },
    getTitle() {
    ...
    addShow() {
      ...
      if (this.isAdd && this.showTab < 7) this.showTab++
